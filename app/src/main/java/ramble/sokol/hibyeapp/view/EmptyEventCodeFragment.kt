...
class EmptyEventCodeFragment : Fragment() {

    private var binding: FragmentEmptyEventCodeBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentEmptyEventCodeBinding.inflate(inflater, container, false)
